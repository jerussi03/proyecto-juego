# Controles actualizados: estilo KOF
...
| D | Activar MAX, cuesta 1000 de energía |
...
.\Ikemen_GO.exe -debug -p1 chava/chava-qa.def -p2 kfm -s stages/patio.def -p2.life 10000 -p2.lifeMax 10000 -time 40
```
