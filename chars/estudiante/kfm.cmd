...
; Alex's signature super. Directions and buttons are abstract MUGEN/IKEMEN
; actions, so this works with any configured keyboard, pad or arcade stick.
[Command]
name = "AI_Summon"
command = ~D, DB, B, x
time = 20
...
;===========================================================================
; Invocación de IA — QCB + puño. This comes before legacy QCB entries so
; the signature move always wins when the player has one power bar.
[State -1, Invocacion de IA]
type = ChangeState
value = 3100
triggerall = command = "AI_Summon"
...
type = ChangeState
value = 1220
; Reserved: QCB is Alex's IA input. Keep the old sample move unreachable.
triggerall = 0
triggerall = power >= 330
trigger1 = var(1) ;Use combo condition (above)
